...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark">
      ...
      <body className="antialiased min-h-screen text-slate-100 bg-neutral-950 font-sans selection:bg-violet-600 selection:text-white" style={{ fontFamily: "'Plus Jakarta Sans', 'Outfit', sans-serif" }}>
        <ToastProvider>
          {children}
        </ToastProvider>
      </body>
