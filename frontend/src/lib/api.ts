...
const INITIAL_KNOWLEDGE_BASES: KnowledgeBase[] = [
  { id: "kb-1", name: "AcuraX Strategy Hub", type: "file", source: "3 Documents", status: "synced", lastSync: "2026-06-23 18:45", docCount: 3 },
  { id: "kb-2", name: "Developer Wiki Scraper", type: "web", source: "https://docs.acurax.ai/dev", status: "synced", lastSync: "2026-06-24 09:12", docCount: 84 },
];
