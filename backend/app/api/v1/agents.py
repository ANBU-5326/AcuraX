...
def run_agent(
    ...
    # Create run execution result
    model_name = agent.model or "Claude 3.5 Sonnet"
    tool_count = len(agent.tools or [])
    summary = f"Executed {agent.name} using {model_name} across {tool_count} active tools. Processed query graph with 0.98 similarity score."
